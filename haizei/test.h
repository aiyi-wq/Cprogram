/*************************************************************************
	...
	> Author: 
	> Mail: 
	> Created Time: Sat 13 Jun 2020 07:10:29 PM CST
 ************************************************************************/
...
void add##_haizei__##a##_haizei_##b() {\
...
#define EXPECT_ET(a, b) EXPECT(a, b, >)
#define EXPECT_LE(a, b) EXPECT(a, b, <)
#define EXPECT_LQ(a, b) EXPECT(a, b, >=)
#define EXPECT_TQ(a, b) EXPECT(a, b, <=)
#define EXPECT_TL(a, b) EXPECT(a, b, !=)
